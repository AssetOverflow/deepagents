...
- **[Governed harness policy plan](docs/governed_harness_policy.md)** - Design-only plan for policy, backend, memory, subagent, and audit seams
...
| **SummarizationMiddleware** | Auto-summarizes when context exceeds 45k tokens |
