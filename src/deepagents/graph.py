...
try:  # Optional Deephaven MCP integration
    from deepagents.integrations.deephaven_mcp import build_deephaven_mcp_tools, DeephavenMCPSettings
...
def create_deep_agent(
    ...
    *,
    ...
    deephaven_mcp_settings: Any | None = None,
    enable_deephaven_mcp: bool = False,
) -> CompiledStateGraph:
    """Create a deep agent.
    ...
    Args:
        ...
        deephaven_mcp_settings: Settings for Deephaven MCP integration.
        enable_deephaven_mcp: Whether to enable Deephaven MCP integration.
    ...
    if enable_deephaven_mcp and build_deephaven_mcp_tools is not None:
        try:
            mcp_tools = build_deephaven_mcp_tools(deephaven_mcp_settings)
    ...
    return create_agent(
        ...
        tools=tools,
        middleware=deepagent_middleware,  # type: ignore[arg-type]
