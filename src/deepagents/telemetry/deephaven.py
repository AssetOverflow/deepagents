...
try:
    # TODO: PyDeephaven 0.39.8+ no longer has experimental.dtypes
    # For now, use string-based types which are compatible with Deephaven server
    # This should be updated once PyDeephaven provides a stable dtype API
    dh_dtypes = None  # Force use of string types
